...
def analyze_pred_gt_image(data, i, threshold):
    ...
    imageio.imwrite("sampleImages/pred_bbox_" + filename, imgaug_bbox_single_img.draw_on_image(img, size=2))

    # draw the ground truth
    label_file = filename.split('.jpg')[0] + '.txt'
    draw_ground_truth_label(label_file, img, 'sampleImages/gt_bbox_' + filename)
